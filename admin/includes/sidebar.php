   ...
   <div class="sidebar_blog_2">
      ...
      <ul class="list-unstyled components">
         ...
         <?php if (hasPermission('manage_courses')): ?>
            <li class="border-bottom border-light">
               <a href="#course_management" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-book orange_color"></i> <span>Course Management</span></a>
               <ul class="collapse list-unstyled" id="course_management">
                  <li><a href="<?php echo ADMIN_URL; ?>courses.php">> <span>Manage Courses</span></a></li>
                  <li><a href="<?php echo ADMIN_URL; ?>categories.php">> <span>Manage Categories</span></a></li>
                  <li><a href="<?php echo ADMIN_URL; ?>all_batches.php">> <span>Manage All Batches</span></a></li>
                  <li><a href="<?php echo ADMIN_URL; ?>add_course.php">> <span>Add New Course</span></a></li>
               </ul>
            </li>
         <?php endif; ?>
         ...
         <?php if (hasPermission('view_my_courses')): ?>
